...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{list_verifications}
\end{center}
\caption{User Interface for Selecting Attributes}
\label{fig:verifications}
\end{figure}

The user interface for selecting attributes (Figure 
\ref{fig:verifications}) allows students to simply check the ones 
that apply, and also makes a distinction between attributes 
entered by the course staff (in blue) and those entered by the 
students (in black).
