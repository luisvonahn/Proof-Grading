...
personal attention by expert mentors \citep{anderson-jmb86}.
...
Important work has been done on the use of computer-based tools in
teaching students to write proofs.  These include computerized tutors
for high school geometry \citep{anderson-jmb86} and introductory formal
logic \citep{scheines-93,scheines-94}.  These tutors include checkers
...
written at a very low level of detail, explictly stating the
justification of each inference step.  Researchers at Stanford have
...
writing a program: there is a very strict and formal structure,
whereas the latter is more like an essay: it must conform to a logical
structure, but without giving explicit, low-level details.
...
sophistication.  In our experience, even our 
...
Indeed, we claim that the baseline for comparison for assessing
proofs should not be that of an expert giving a careful review, but a more
...
process would help the improve their own skills.
...
grant provides improved understanding of the strengths and weaknesses 
